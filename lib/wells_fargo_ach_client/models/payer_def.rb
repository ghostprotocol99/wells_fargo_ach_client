...
module WellsFargoAchClient
  # Business or consumer funding the payment. Requires name and bank_information for payer.
  class PayerDEF
    ...
    # Use this field to indicate whether the payer is a consumer (C) or business (B).
    attr_accessor :business_consumer_indicator

    # Name of the payer.
    attr_accessor :name

    # Payer email address. No validation will be applied to the email address.
    attr_accessor :email
    ...
    def valid?
      ...
      return false if !@phone.nil? && @phone.to_s.length < 10
      business_consumer_indicator_validator = EnumAttributeValidator.new('String', ['B', 'C'])
    ...
    def business_consumer_indicator=(business_consumer_indicator)
      validator = EnumAttributeValidator.new('String', ['B', 'C'])
