...
module WellsFargoAchClient
  class InvoiceDEFAdjustmentInformation
    # Allows for multiple adjustments to an invoice.
    ...
    def self.swagger_types
      {
        :'adjustment' => :'Array<AdjustmentDEF>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adjustment')
        if (value = attributes[:'adjustment']).is_a?(Array)
