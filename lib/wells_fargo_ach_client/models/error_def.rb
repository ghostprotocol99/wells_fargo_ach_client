...
module WellsFargoAchClient
  class ErrorDEF
    # A code describing the result of processing.
    attr_accessor :error_code

    # A human-readable explanation. The message is not intended for algorithmic processing and is subject to change.
    attr_accessor :description

    # The field name where the error occurred.
    attr_accessor :field_name

    # The field value entered in the request by the user.
    attr_accessor :field_value

    # A link to the API specification.
    attr_accessor :api_specification_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'api_specification_url')
        self.api_specification_url = attributes[:'api_specification_url']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @error_code.to_s.length < 7
        invalid_properties.push('invalid value for "error_code", the character length must be great than or equal to 7.')
      end
    ...
    def valid?
      ...
      return false if @error_code.to_s.length < 7
    ...
    def error_code=(error_code)
      ...
      if error_code.to_s.length < 7
        fail ArgumentError, 'invalid value for "error_code", the character length must be great than or equal to 7.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          api_specification_url == o.api_specification_url
    end
    ...
    def hash
      [error_code, description, field_name, field_value, api_specification_url].hash
    end
